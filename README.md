...
- تسجيل المدفوعات الشهرية مع إمكانية إرفاق إيصال (صورة/PDF) ودعم الدفع الجزئي
- تسجيل المصروفات بتصنيفات مع إيصالات
- **رصيد الصندوق التراكمي** (إجمالي المحصّل − المصروفات) + رسم بياني لتطوّره عبر الزمن
- **متابعة المتأخرات**: المتبقّي على كل ساكن مع **ترحيل الفائض** تلقائيًا للأشهر التالية
- **كشف حساب لكل ساكن** (سجل شهري + رصيد جارٍ) قابل للتصدير PDF
- **تذكير واتساب** للمدينين برسالة جاهزة بضغطة زر
- لوحة رئيسية بنظرة شاملة + رسم بياني آخر 6 أشهر + توزيع المصروفات حسب الفئة
- تصدير تقرير PDF شهري كامل بالعربي (RTL) + تصدير المتأخرات إلى CSV
